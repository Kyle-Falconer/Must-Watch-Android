...
class LogFormFragment : Fragment() {
    ...
    private var viewModel: LogFormViewModel? = null
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory!!).get(LogFormViewModel::class.java)
    ...
    private fun updateUiDateTime() {
        ...
        val timeField = activity!!.findViewById<TextView>(R.id.createDateTime)
        if (timeField != null) {
            timeField.text = calendarToLocaleTime(viewModel!!.logEntry.entryDate)
        } else {
        ...
        val dateField = activity!!.findViewById<TextView>(R.id.createDateDate)
        if (dateField != null) {
            dateField.text = calendarToLocaleDate(viewModel!!.logEntry.entryDate)
        } else {
    ...
    companion object {
        private val TAG = LogFormFragment::class.java.simpleName
